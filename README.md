...
**Pill:ease(필리즈)** 는 ***제 5회 KB국민은행 소프트웨어 경진대회***를 위한 프로젝트로, 환경을 생각한 복용부터 처리까지 도와주는 서비스를 제공한다. 올바른 약 복용부터 남은 약에 대한 처리 방법을 사용자에게 알림으로써 폐의약품 배출과 관련한 시민들의 인식을 개선하고, 안전한 처리로 국민건강과 환경을 지킬 수 있을 것이다.  
...
|------------------|-----------------------|----------------------------------|-----------|
| 👧🏻 DongYeon Kang(Team Member) | myjjue00@gmail.com    | https://github.com/dongyeon-0822 | BE |
| 👱🏻‍♀️ Hyewon Kang(Team Leader)  | gpffps369@gmail.com   | https://github.com/HyewonKkang   | FE |
| 🧒🏻 Gunwoo Kim(Team Member)    | gun0005@naver.com     | https://github.com/Gu-nuu        | FE |
| 👱🏻‍♂️ Taekyu Lee(Team Member)   | dnjsqls2008@gmail.com | https://github.com/leetaekyu2077 | BE  |
